...
tableRA1852_latlong <-surfaces_ra1852_coordonnees_centre_corrigees %>%
  ...
  mutate(latitude=str_split_fixed(COORDO, ",",2)[,1]) %>%  #la fonction str_plit_fixed permet de séparer une colonne en "2" à partir du caractère ",". le [,1] permet de lui préciser quelle est la colonne qu'il doit retenir pour la latitude
  mutate(longitude=str_split_fixed(COORDO, ",",2)[,2]) #idem ici avec la 2eme colonne
